...
You didn't slow it enough and it begins eating your toes when it catches you.""")
        ...
        print "You throw some dog food shaped like brains into a far corner, distracting the Zombie and rush through the door."
        treasure_room()
    else:
        dead("Well that didn't work did it.")

# Library 2 exit rooms
def lib_2_exit(dir, top, side):
    print "You have stepped into another of the many rooms in the Library."
    print "2 Exit"
    random_text()
    directions_out(dir, top, side, 0)
    

# Corner Rooms (came_from, top, corner, side): lib_corner(choice, 1, side)
def lib_corner(dir, top, side):
    print "You have stepped into another of the many rooms in the Library."
    print "Corner!!!"
    random_text()
    directions_out(dir, top, side, 1)
...
due to the confusing nature of the Library.""",
    ...
    "You notice a slight humming coming from the walls of this room. That is quite stranges.",
